...
class UploadSmartphones extends StatefulWidget {
  @override
  _UploadSmartphonesState createState() => _UploadSmartphonesState();
}

class _UploadSmartphonesState extends State<UploadSmartphones> {
                          ...
                          children: <Widget>[
                            ...
                            Flexible(
                              ...
                              child: TextFormField(
                                ...
                                onSaved: (value) => _productRam = value,
                                showCursor: true,
                                decoration: InputDecoration(
                                  border: OutlineInputBorder(
                                    borderRadius:
    ...
    if(_formkey.currentState.validate()){
      ...
      try{
        ...
        if (image != null){
          ...
          var snapshot = await _storage.ref().child("Smartphones/$image_names").putFile(file).onComplete;
          ...
          setData({'product_brand':_productbrand,'picture':_imageName,'product_status':_productstatus,'price':_price,
            ...
            'product_category':'Smartphones','product':'Smartphones','timestamp':DateTime.now().toUtc().millisecondsSinceEpoch,
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => UploadSmartphones()));
