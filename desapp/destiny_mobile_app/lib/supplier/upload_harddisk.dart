...
class UploadHarddisks extends StatefulWidget {
  @override
  _UploadHarddisksState createState() => _UploadHarddisksState();
}

class _UploadHarddisksState extends State<UploadHarddisks> {
    ...
    if(_formkey.currentState.validate()){
      ...
      try{
        ...
        if (image != null){
          ...
          var snapshot = await _storage.ref().child("Harddisks/$image_names").putFile(file).onComplete;
          ...
          setData({'product_brand':_productbrand,'picture':_imageName,'product_status':_productstatus,'price':_price,
            ...
            'product_category':'Harddisks','product':'Accessories','timestamp':DateTime.now().toUtc().millisecondsSinceEpoch,
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => UploadHarddisks()));
