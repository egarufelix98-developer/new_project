...
class UploadHeadsets extends StatefulWidget {
  @override
  _UploadHeadsetsState createState() => _UploadHeadsetsState();
}

class _UploadHeadsetsState extends State<UploadHeadsets> {
    ...
    if(_formkey.currentState.validate()){
      ...
      try{
        ...
        if (image != null){
          ...
          var snapshot = await _storage.ref().child("Headsets/$image_names").putFile(file).onComplete;
          ...
          setData({'product_brand':_productbrand,'picture':_imageName,'product_status':_productstatus,'price':_price,
            ...
            'product_category':'Headsets','product':'Accessories','timestamp':DateTime.now().toUtc().millisecondsSinceEpoch,
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => UploadHeadsets()));
