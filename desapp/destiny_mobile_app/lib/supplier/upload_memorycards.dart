...
class UploadMemoryCards extends StatefulWidget {
  @override
  _UploadMemoryCardsState createState() => _UploadMemoryCardsState();
}

class _UploadMemoryCardsState extends State<UploadMemoryCards> {
    ...
    if(_formkey.currentState.validate()){
      ...
      try{
        ...
        if (image != null){
          ...
          var snapshot = await _storage.ref().child("MemoryCards/$image_names").putFile(file).onComplete;
          ...
          setData({'product_brand':_productbrand,'picture':_imageName,'product_status':_productstatus,'price':_price,
            ...
            'product_category':'MemoryCards','product':'Accessories','timestamp':DateTime.now().toUtc().millisecondsSinceEpoch,
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => UploadMemoryCards()));
