...
class UploadScreenGuards extends StatefulWidget {
  @override
  _UploadScreenGuardsState createState() => _UploadScreenGuardsState();
}

class _UploadScreenGuardsState extends State<UploadScreenGuards> {
    ...
    if(_formkey.currentState.validate()){
      ...
      try{
        ...
        if (image != null){
          ...
          var snapshot = await _storage.ref().child("ScreenGuards/$image_names").putFile(file).onComplete;
          ...
          setData({'product_brand':_productbrand,'picture':_imageName,'product_status':_productstatus,'price':_price,
            ...
            'product_category':'ScreenGuards','product':'Accessories','timestamp':DateTime.now().toUtc().millisecondsSinceEpoch,
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => UploadScreenGuards()));
