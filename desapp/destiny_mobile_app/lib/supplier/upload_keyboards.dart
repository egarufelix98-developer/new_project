...
class UploadKeyBoards extends StatefulWidget {
  @override
  _UploadKeyBoardsState createState() => _UploadKeyBoardsState();
}

class _UploadKeyBoardsState extends State<UploadKeyBoards> {
    ...
    if(_formkey.currentState.validate()){
      ...
      try{
        ...
        if (image != null){
          ...
          var snapshot = await _storage.ref().child("Keyboards/$image_names").putFile(file).onComplete;
          ...
          setData({'product_brand':_productbrand,'picture':_imageName,'product_status':_productstatus,'price':_price,
            ...
            'product_category':'Keyboards','product':'Accessories','timestamp':DateTime.now().toUtc().millisecondsSinceEpoch,
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => UploadKeyBoards()));
