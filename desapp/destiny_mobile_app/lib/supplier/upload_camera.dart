...
class UploadCameras extends StatefulWidget {
  @override
  _UploadCamerasState createState() => _UploadCamerasState();
}

class _UploadCamerasState extends State<UploadCameras> {
    ...
    if(_formkey.currentState.validate()){
      ...
      try{
        ...
        if (image != null){
          ...
          var snapshot = await _storage.ref().child("Cameras/$image_names").putFile(file).onComplete;
          ...
          setData({'product_brand':_productbrand,'picture':_imageName,'product_status':_productstatus,'price':_price,
            ...
            'product_category':'Cameras','product':'Cameras','timestamp':DateTime.now().toUtc().millisecondsSinceEpoch,
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => UploadCameras()));
