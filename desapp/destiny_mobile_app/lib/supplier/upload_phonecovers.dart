...
class UploadPhoneCovers extends StatefulWidget {
  @override
  _UploadPhoneCoversState createState() => _UploadPhoneCoversState();
}

class _UploadPhoneCoversState extends State<UploadPhoneCovers> {
    ...
    if(_formkey.currentState.validate()){
      ...
      try{
        ...
        if (image != null){
          ...
          var snapshot = await _storage.ref().child("PhoneCovers/$image_names").putFile(file).onComplete;
          ...
          setData({'product_brand':_productbrand,'picture':_imageName,'product_status':_productstatus,'price':_price,
            ...
            'product_category':'PhoneCovers','product':'Accessories','timestamp':DateTime.now().toUtc().millisecondsSinceEpoch,
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => UploadPhoneCovers()));
