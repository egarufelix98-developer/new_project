...
class UploadLaptops extends StatefulWidget {


  @override
  _UploadLaptopsState createState() => _UploadLaptopsState();
}

class _UploadLaptopsState extends State<UploadLaptops> {
    ...
    if(_formkey.currentState.validate()){
      ...
      try{
        ...
        if (image != null){
          ...
          var snapshot = await _storage.ref().child("Laptops/$image_names").putFile(file).onComplete;
          ...
          setData({'product_brand':_productbrand,'picture':_imageName,'product_status':_productstatus,'price':_price,
            ...
            'product_category':'Laptops','product':'Laptops','timestamp':DateTime.now().toUtc().millisecondsSinceEpoch,
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => UploadLaptops()));
