import 'package:destiny_mobile_app/clients/DeliveryAddress.dart';
import 'package:flutter/material.dart';

class ProductDetailsSignedIn extends StatelessWidget {
  ProductDetailsSignedIn({this.passed});
  final passed;
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => DeliveryAddress(pass: passed),
                              ),
                            );
                          },
                          child: Text(
